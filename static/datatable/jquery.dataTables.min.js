...
sLengthMenu:"Exibindo _MENU_ registros",sZeroRecords:"Nenhum registro encontrado",sEmptyTable:"Nenhum registro cadastrado até então.",sInfo:"Exibindo _START_ de _END_ no total de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 de 0 no total de 0 registros",sInfoFiltered:"(filtrado no total de _MAX_ registros)",sInfoPostFix:"",sSearch:"Pesquisar:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.iNextId=0;this.asDataSearch=
